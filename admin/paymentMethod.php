...
<div class="card card-warning">
  ...
  <div class="card-body">
    <form method="post" action="../controller/payment.php">
      <div class="row">
        ...
        <div class="col-sm-2"> 
          <button type="submit" name="add" class="btn btn-block btn-success">Add New Payment Method</button>                
        </div> 
      </div> 
    </form>
  </div>
          ...
          <div class="col-12">
            <div class="card">
            <div class="card-header">
              <h3 class="card-title">Payment Method table</h3>
              </div>
              <!-- /.card-header -->
  ...
  <?php foreach ($PaymentMethod as $pay) { ?>
    <tr>
        <td><?php echo $pay->getId(); ?></td>
        <td><?php echo $pay->getName(); ?></td>
        
        <td>
        <a href="../controller/payment.php?delete=1&id=<?php echo $pay->getId(); ?>">Delete</a></td>
    </tr>
<?php
}
?>
...
<script>
    ...
    // Checking if the payment method is empty
    if (paymentMethod === "") {
